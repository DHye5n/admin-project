            ...
            <div className='footer-container'>
                <div className='footer-top'>
                    <div className='footer-logo-box'>
                        ...
                        <div className='footer-copyright'>{'Copyright ⓒ 2024 DHy25n. All Rights Reserved.'}</div>
                    </div>

                    <div className='footer-link-box'>
                        <div className='footer-link-item'>
                            <div className='icon-button' onClick={onEmailIconButtonClickHandler}>
                        ...
                        <div className='footer-link-item'>
                            ...
                            <div className='footer-logo-link-text'>{'github.com/DHye5n/admin-project'}</div>
                        </div>
                        ...
                        <div className='footer-link-item'>
                            ...
                            <div className='footer-logo-link-text'>{'sai4875.tistory.com'}</div>
                        </div>
                    </div>
                </div>
            </div>
